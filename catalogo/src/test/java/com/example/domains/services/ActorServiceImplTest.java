...
class ActorServiceImplTest {
	...
	void testGetAll_isNotEmpty() {
		List<Actor> lista = new ArrayList<>(Arrays.asList(
				new Actor(1, "Pepe", "FERNANDEZ"),
				new Actor(2, "Pepa", "SUAREZ"), 
				new Actor(3, "Paco", "PIL")));
	...
	void testGetOne_valid() {
		...
		when(dao.findById(1)).thenReturn(Optional.of(new Actor(1, "Pepe", "FERNANDEZ")));
	...
	void testAddDuplicateKeyKO() throws DuplicateKeyException, InvalidDataException {
		...
		assertThrows(DuplicateKeyException.class, () -> srv.add(new Actor(1, "PP", "NDEZ")));
	}
